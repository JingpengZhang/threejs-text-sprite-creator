import { LinearFilter, Object3DEventMap, Sprite, SpriteMaterial, Texture } from 'three';
import CreateTextCanvasElement, { CreateTextCanvasElementOptions } from './CreateTextCanvasElement';

class TextSprite<TEventMap extends Object3DEventMap = Object3DEventMap> extends Sprite<TEventMap> {
  // 文本
